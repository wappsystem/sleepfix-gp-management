(function(){
    ...
    var modules={
        ...
        "ess-form":   {url:"$H/m/tasks/ess-form.html",   Table:"sleepfix-gp-ess",task_name:"Sleepiness",page:"Page 4 of 8"},
        "ffs-data":   {url:"$H/m/tasks/ffs-data.html",   Table:"sleepfix-gp-ffs", form_module:"ffs-form",task_name:"Flinder Fatigue Scale"},
        "ffs-form":   {url:"$H/m/tasks/ffs-form.html",   Table:"sleepfix-gp-ffs",task_name:"Fatigue",page:"Page 5 of 8"},
        ...
        "gad-7-form":   {url:"$H/m/tasks/gad-7-form.html",   Table:"sleepfix-gp-gad-7",task_name:"Anxiety",page:"Page 8 of 8"},
        ...
        "ess-w6-form":   {url:"$H/m/tasks/ess-form.html",   Table:"sleepfix-gp-ess-w6",task_name:"Sleepiness - Week 6",page:"Page 3 of 9"},
        ...
        "ffs-w6-form":   {url:"$H/m/tasks/ffs-form.html",   Table:"sleepfix-gp-ffs-w6",task_name:"Fatigue - Week 6",page:"Page 4 of 9"},
        ...
        "ieuq-w6-form":   {url:"$H/m/tasks/ieuq-form.html",   Table:"sleepfix-gp-ieuq-w6",task_name:"SleepFix App",page:"Page 7 of 9"},
        ...
        "gad-7-w6-form":   {url:"$H/m/tasks/gad-7-form.html",   Table:"sleepfix-gp-gad-7-w6",task_name:"Anxiety - Week 6",page:"Page 9 of 9"},
