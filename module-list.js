(function(){
    ...
    var modules={
        ...
        "baseline-form":   {url:"$H/m/tasks/baseline-form.html",   Table:"sleepfix-gp-baseline",task_name:"Baseline Questionnaire"},
        ...
        "sq-form":   {url:"$H/m/tasks/sq-form.html",   Table:"sleepfix-gp-sq",task_name:"Sleep Quality"},
        "ess-data":   {url:"$H/m/tasks/ess-data.html",   Table:"sleepfix-gp-ess", form_module:"ess-form",task_name:"ESS"},
        "ess-form":   {url:"$H/m/tasks/ess-form.html",   Table:"sleepfix-gp-ess",task_name:"ESS"},
        "ffs-data":   {url:"$H/m/tasks/ffs-data.html",   Table:"sleepfix-gp-ffs", form_module:"ffs-form",task_name:"Flinder Fatigue Scale"},
        "ffs-form":   {url:"$H/m/tasks/ffs-form.html",   Table:"sleepfix-gp-ffs",task_name:"Flinder Fatigue Scale"},
        ...
        "gad-7-form":   {url:"$H/m/tasks/gad-7-form.html",   Table:"sleepfix-gp-gad-7",task_name:"GAD-7"},
        "isi-w6-data":   {url:"$H/m/tasks/isi-data.html",   Table:"sleepfix-gp-isi-w6", form_module:"isi-w6-form",task_name:"ISI Week 6"},
        "isi-w6-form":   {url:"$H/m/tasks/isi-form.html",   Table:"sleepfix-gp-isi-w6",task_name:"ISI Week 6"},
        "sq-w6-data":   {url:"$H/m/tasks/sq-data.html",   Table:"sleepfix-gp-sq-w6", form_module:"sq-w6-form",task_name:"Sleep Quality Week 6"},
        "sq-w6-form":   {url:"$H/m/tasks/sq-form.html",   Table:"sleepfix-gp-sq-w6",task_name:"Sleep Quality Week 6"},
        "ess-w6-data":   {url:"$H/m/tasks/ess-data.html",   Table:"sleepfix-gp-ess-w6", form_module:"ess-w6-form",task_name:"ESS Week 6"},
        "ess-w6-form":   {url:"$H/m/tasks/ess-form.html",   Table:"sleepfix-gp-ess-w6",task_name:"ESS Week 6"},
        ...
        "ffs-w6-form":   {url:"$H/m/tasks/ffs-form.html",   Table:"sleepfix-gp-ffs-w6",task_name:"Flinder Fatigue Scale Week 6"},
        ...
        "gad-7-w6-form":   {url:"$H/m/tasks/gad-7-form.html",   Table:"sleepfix-gp-gad-7-w6",task_name:"GAD-7 Week 6"},
