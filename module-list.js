(function(){
    ...
    var modules={
        ...
        "baseline-form":   {url:"$H/m/tasks/baseline-form.html",   Table:"sleepfix-gp-baseline",task_name:"Baseline Questionnaire",page:"Page 1 of 7"},
        "isi-data":   {url:"$H/m/tasks/isi-data.html",   Table:"sleepfix-gp-isi", form_module:"isi-form",task_name:"ISI"},
        "isi-form":   {url:"$H/m/tasks/isi-form.html",   Table:"sleepfix-gp-isi",task_name:"Insomnia",page:"Page 2 of 7"},
        "sq-data":   {url:"$H/m/tasks/sq-data.html",   Table:"sleepfix-gp-sq", form_module:"sq-form",task_name:"Sleep Quality"},
        "sq-form":   {url:"$H/m/tasks/sq-form.html",   Table:"sleepfix-gp-sq",task_name:"Sleep Quality",page:"Page 3 of 7"},
        "ess-data":   {url:"$H/m/tasks/ess-data.html",   Table:"sleepfix-gp-ess", form_module:"ess-form",task_name:"ESS"},
        "ess-form":   {url:"$H/m/tasks/ess-form.html",   Table:"sleepfix-gp-ess",task_name:"Sleepiness",page:"Page 4 of 7"},
        "ffs-data":   {url:"$H/m/tasks/ffs-data.html",   Table:"sleepfix-gp-ffs", form_module:"ffs-form",task_name:"Flinder Fatigue Scale"},
        "ffs-form":   {url:"$H/m/tasks/ffs-form.html",   Table:"sleepfix-gp-ffs",task_name:"Fatigue",page:"Page 5 of 7"},
        "phq-9-data":   {url:"$H/m/tasks/phq-9-data.html",   Table:"sleepfix-gp-phq-9", form_module:"phq-9-form",task_name:"PHQ-9"},
        "phq-9-form":   {url:"$H/m/tasks/phq-9-form.html",   Table:"sleepfix-gp-phq-9",task_name:"Health",page:"Page 6 of 7"},
        "gad-7-data":   {url:"$H/m/tasks/gad-7-data.html",   Table:"sleepfix-gp-gad-7", form_module:"gad-7-form",task_name:"GAD-7"},
        "gad-7-form":   {url:"$H/m/tasks/gad-7-form.html",   Table:"sleepfix-gp-gad-7",task_name:"Anxiety",page:"Page 7 of 7"},
        "isi-w6-data":   {url:"$H/m/tasks/isi-data.html",   Table:"sleepfix-gp-isi-w6", form_module:"isi-w6-form",task_name:"ISI Week 6"},
        "isi-w6-form":   {url:"$H/m/tasks/isi-form.html",   Table:"sleepfix-gp-isi-w6",task_name:"Insomnia - Week 6",page:"Page 1 of 6"},
        "sq-w6-data":   {url:"$H/m/tasks/sq-data.html",   Table:"sleepfix-gp-sq-w6", form_module:"sq-w6-form",task_name:"Sleep Quality Week 6"},
        "sq-w6-form":   {url:"$H/m/tasks/sq-form.html",   Table:"sleepfix-gp-sq-w6",task_name:"Sleep Quality - Week 6",page:"Page 2 of 6"},
        "ess-w6-data":   {url:"$H/m/tasks/ess-data.html",   Table:"sleepfix-gp-ess-w6", form_module:"ess-w6-form",task_name:"ESS Week 6"},
        "ess-w6-form":   {url:"$H/m/tasks/ess-form.html",   Table:"sleepfix-gp-ess-w6",task_name:"Sleepiness - Week 6",page:"Page 3 of 6"},
        ...
        "ffs-w6-form":   {url:"$H/m/tasks/ffs-form.html",   Table:"sleepfix-gp-ffs-w6",task_name:"Fatigue - Week 6",page:"Page 4 of 6"},
        "phq-9-w6-data":   {url:"$H/m/tasks/phq-9-data.html",   Table:"sleepfix-gp-phq-9-w6", form_module:"phq-9-w6-form",task_name:"PHQ-9 Week 6"},
        "phq-9-w6-form":   {url:"$H/m/tasks/phq-9-form.html",   Table:"sleepfix-gp-phq-9-w6",task_name:"Health - Week 6",page:"Page 5 of 6"},
        "gad-7-w6-data":   {url:"$H/m/tasks/gad-7-data.html",   Table:"sleepfix-gp-gad-7-w6", form_module:"gad-7-w6-form",task_name:"GAD-7 Week 6"},
        "gad-7-w6-form":   {url:"$H/m/tasks/gad-7-form.html",   Table:"sleepfix-gp-gad-7-w6",task_name:"Anxiety - Week 6",page:"Page 6 of 6"},
